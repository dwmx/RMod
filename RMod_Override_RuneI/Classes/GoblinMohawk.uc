...
// GoblinMohawk.
//=============================================================================
class GoblinMohawk expands Goblin;
...
defaultproperties
{
     GoblinLimb=LIMB_NORMAL
     GoblinTorso=TORSO_NORMAL
     goblinhead=HEAD_NORMAL
     FightOrFlight=1.000000
     BreathSound=Sound'CreaturesSnd.Goblin.goblinbreath05'
     AcquireSound=Sound'CreaturesSnd.Goblin.goblinsee01'
     AmbientWaitSounds(0)=Sound'CreaturesSnd.Goblin.goblinamb14'
     AmbientWaitSounds(1)=Sound'CreaturesSnd.Goblin.goblinsee05'
     AmbientWaitSounds(2)=Sound'CreaturesSnd.Goblin.goblinword09'
     AmbientFightSounds(0)=Sound'CreaturesSnd.Goblin.goblinattack12'
     AmbientFightSounds(1)=Sound'CreaturesSnd.Goblin.goblinattack08'
     AmbientFightSounds(2)=Sound'CreaturesSnd.Goblin.goblinattack32'
     AmbientWaitSoundDelay=7.000000
     AmbientFightSoundDelay=4.000000
     StartWeapon=Class'RuneI.goblinaxe'
     Health=75
     HitSound1=Sound'CreaturesSnd.Goblin.goblinhit30'
     HitSound2=Sound'CreaturesSnd.Goblin.goblinhit26'
     HitSound3=Sound'CreaturesSnd.Goblin.goblinattack17'
     Die=Sound'CreaturesSnd.Goblin.goblindeath07'
     Die2=Sound'CreaturesSnd.Goblin.goblindeath11'
     Die3=Sound'CreaturesSnd.Goblin.goblindeath03'
     SkelMesh=3
}
