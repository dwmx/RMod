...
// ScriptableRagnar.
//=============================================================================
class ScriptableRagnar expands Viking;
...
function Texture PainSkin(int BodyPart)
{
	switch(BodyPart)
	{
		case BODYPART_TORSO:
			...
			break;
		case BODYPART_HEAD:
			SkelGroupSkins[13] = Texture'players.ragnartn_headpain';
			break;
		case BODYPART_LARM1:
...
defaultproperties
{
     ...
     SkelGroupSkins(13)=Texture'Players.Ragnartn_head'
     SkelGroupSkins(14)=Texture'Players.Ragnarragd_hornhelmet'
