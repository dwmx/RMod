...
defaultproperties
{
     ...
     BreathSound=Sound'CreaturesSnd.Dwarves.breath01'
     AcquireSound=Sound'CreaturesSnd.Dwarves.attack27'
     AmbientWaitSounds(0)=Sound'CreaturesSnd.Dwarves.attack07'
     AmbientWaitSounds(1)=Sound'CreaturesSnd.Dwarves.anger04'
     AmbientWaitSounds(2)=Sound'CreaturesSnd.Dwarves.ambient06'
     AmbientFightSounds(0)=Sound'CreaturesSnd.Dwarves.attack25'
     AmbientFightSounds(1)=Sound'CreaturesSnd.Dwarves.attack23'
     AmbientFightSounds(2)=Sound'CreaturesSnd.Dwarves.attack08'
     AmbientWaitSoundDelay=11.000000
     AmbientFightSoundDelay=4.500000
     HitSound1=Sound'CreaturesSnd.Dwarves.hit36'
     HitSound2=Sound'CreaturesSnd.Dwarves.hit31'
     HitSound3=Sound'CreaturesSnd.Dwarves.hit37'
     Die=Sound'CreaturesSnd.Dwarves.death05'
     Die2=Sound'CreaturesSnd.Dwarves.death08'
     Die3=Sound'CreaturesSnd.Dwarves.death26'
     SkelMesh=5
}
