...
defaultproperties
{
     ...
     BreathSound=Sound'CreaturesSnd.Dwarves.breath04'
     AcquireSound=Sound'CreaturesSnd.Dwarves.grunt13'
     AmbientWaitSounds(0)=Sound'CreaturesSnd.Dwarves.ambient07'
     AmbientWaitSounds(1)=Sound'CreaturesSnd.Dwarves.ambient13'
     AmbientWaitSounds(2)=Sound'CreaturesSnd.Dwarves.word18'
     AmbientFightSounds(0)=Sound'CreaturesSnd.Dwarves.attack05'
     AmbientFightSounds(1)=Sound'CreaturesSnd.Dwarves.attack06'
     AmbientFightSounds(2)=Sound'CreaturesSnd.Dwarves.attack04'
     AmbientFightSoundDelay=5.000000
     HitSound1=Sound'CreaturesSnd.Dwarves.hit18'
     HitSound2=Sound'CreaturesSnd.Dwarves.attack18'
     HitSound3=Sound'CreaturesSnd.Dwarves.hit08'
     Die=Sound'CreaturesSnd.Dwarves.death14'
     Die2=Sound'CreaturesSnd.Dwarves.death25'
     Die3=Sound'CreaturesSnd.Dwarves.death16'
     SkelMesh=4
}
