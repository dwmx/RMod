...
// UTerminal.ListNode
//=============================================================================
class ListNode expands Object;

var ListNode    Next;
var ListNode    Prev;

var Actor       Actor;          // Optional actor reference
var String      Tag;            // sorted element
var String      Data;           // saved data
var bool        bJustMoved;     // if the map was just moved, keep it selected

function AddElement(ListNode NewElement)
{
    local ListNode TempItem;
...
function AddSortedElement(out ListNode FirstElement, ListNode NewElement)
{
    local ListNode TempItem;
...
function ListNode FindItem(String SearchData)
{
    local ListNode TempItem;
...
function ListNode DeleteElement(out ListNode First, optional String SearchData)
{
    local ListNode TempItem;
    for (TempItem = self; TempItem != None; TempItem = TempItem.Next)
    {
...
function MoveElementUp(out ListNode First, ListNode MoveItem, out int Count)
{
    local ListNode TempItem;
    local int TempCount;
...
function MoveElementDown(out ListNode First, ListNode MoveItem, out int Count)
{
    local ListNode TempItem;
    local int TempCount;
...
function RunTest()
{
    local ListNode Test, TempItem;
    
    Log("Test: Init 'B'");
    Test = new(None) class'ListNode';
    Test.Tag = "B";
    Test.Data = "B";
    Log("  => Test="$Test);
    
    TempItem = new(None) class'ListNode';
    TempItem.Tag = "A";
    TempItem.Data = "A";
    Log("Test: AddSort 'A'");
