...
var() bool bInterpInstant; // RUNE:  Interpolate instantly to this point
...
function BeginPlay()
{
	local InterpolationPoint targIP;

	Super.BeginPlay();

	// Synchronize bSplineThruPoints in all matching interpolation points.
	if(Position == 0)
		foreach AllActors(class 'InterpolationPoint', targIP, Tag)
			targIP.bSplineThruPoints = bSplineThruPoints;
