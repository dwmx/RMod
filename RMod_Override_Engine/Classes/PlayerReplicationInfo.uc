...
var bool				bFirstBlood;	// RUNE: player awarded FirstBlood
var Texture				TalkTexture;
var ZoneInfo			PlayerZone;
var LocationID			PlayerLocation;
var int					MaxSpree;		// RUNE: player awared Spree
var int					HeadKills;		// RUNE: number heads severed
...
replication
{
	...
	reliable if ( Role == ROLE_Authority )
		...
		bAdmin, TalkTexture, PlayerZone, PlayerLocation, StartTime, bReadyToPlay,
		bFirstBlood, MaxSpree, HeadKills;
}
