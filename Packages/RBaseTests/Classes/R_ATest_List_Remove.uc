class R_ATest_List_Remove extends R_ATest_List abstract;

static function String GetTestNameString()
{
	return "Remove one object from list";
}
...
static function bool RunTest(out String FailedResonString)
{
	...
	// Remove object
	ListNode.Remove(MockObject);
	ListLength = ListNode.Length();
	if(ListLength != 0)
	{
		FailedResonString = "List length after removing mock wrong -- expected 0, got" @ ListLength;
		return false;
	}
