...
// TrialPitRagnar.
//=============================================================================
class TrialPitRagnar extends RunePlayer;
...
function Texture PainSkin(int BodyPart)
{
	...
	{
		case BODYPART_TORSO:
			SkelGroupSkins[8] = Texture'players.ragnarragtp_bodypain';
			break;
		case BODYPART_HEAD:
			SkelGroupSkins[7] = Texture'players.ragnarragtp_headpain';
			break;
		case BODYPART_LARM1:
			SkelGroupSkins[9] = Texture'players.ragnarragtp_armspain';
			break;
		case BODYPART_RARM1:
			SkelGroupSkins[4] = Texture'players.ragnarragtp_armspain';
			break;
		case BODYPART_LLEG1:
...
function class<Actor> SeveredLimbClass(int BodyPart)
{
	switch(BodyPart)
	{
		case BODYPART_LARM1:
		case BODYPART_RARM1:
			return class'TrialRagnarArm';
		case BODYPART_HEAD:
			return class'TrialRagnarHead';
	}
...
defaultproperties
{
     CarcassType=Class'RuneI.PlayerTrialPitRagnarCarcass'
     SkelMesh=19
