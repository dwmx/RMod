...
// DarkWarrior.
//=============================================================================
class DarkWarrior expands Viking;
...
defaultproperties
{
     ...
     LungeRange=0.000000
     AcquireSound=Sound'CreaturesSnd.Vikings.vike1see01'
     AmbientWaitSounds(0)=Sound'CreaturesSnd.Vikings.dark2ambient01'
     AmbientWaitSounds(1)=Sound'CreaturesSnd.Vikings.darkattack02'
     AmbientWaitSounds(2)=Sound'CreaturesSnd.Vikings.vike1breath01'
     AmbientFightSounds(0)=Sound'CreaturesSnd.Vikings.dark2attack01'
     AmbientFightSounds(1)=Sound'CreaturesSnd.Vikings.dark2attack02'
     AmbientFightSounds(2)=Sound'CreaturesSnd.Vikings.dark2attack03'
     ...
     HitSound1=Sound'CreaturesSnd.Vikings.dark2hit01'
     HitSound2=Sound'CreaturesSnd.Vikings.dark2hit02'
     HitSound3=Sound'CreaturesSnd.Vikings.dark2hit03'
     Die=Sound'CreaturesSnd.Vikings.dark2death01'
     Die2=Sound'CreaturesSnd.Vikings.dark2death02'
     Die3=Sound'CreaturesSnd.Vikings.dark2death03'
     SkelMesh=18
