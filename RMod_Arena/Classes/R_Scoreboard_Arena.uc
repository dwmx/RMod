...
function DrawPlayerInfo( canvas Canvas, PlayerReplicationInfo PRI, float XOffset, float YOffset)
{
    ...
    GRI = R_GameReplicationInfo_Arena(PlayerOwner.GameReplicationInfo);
...
function DrawHeader( canvas Canvas )
{
    ...
    if (Canvas.ClipX > 500)
    {
        ...
        ArenaGRI = R_GameReplicationInfo_Arena(GRI);
...
function DrawTeamMatchInfo(canvas Canvas, float XOffset, float YStart)
{
    ...
    GRI = R_GameReplicationInfo_Arena(PlayerPawn(Owner).GameReplicationInfo);
...
function ShowScores( canvas Canvas )
{
    ...
    ArenaGRI = R_GameReplicationInfo_Arena(PlayerPawn(Owner).GameReplicationInfo);
    DrawHeader(Canvas);
...
function DrawTrailer( canvas Canvas )
{
    ...
    else if ((PlayerOwner != None) && (PlayerOwner.Health <= 0) )
    {
        ...
        ArenaGRI = R_GameReplicationInfo_Arena(PlayerOwner.GameReplicationInfo);
    ...
    else
    {
        ...
        curMatch = R_GameReplicationInfo_Arena(PlayerOwner.GameReplicationInfo).CurMatch;
        MaxMatch = R_GameReplicationInfo_Arena(PlayerOwner.GameReplicationInfo).FragLimit;
