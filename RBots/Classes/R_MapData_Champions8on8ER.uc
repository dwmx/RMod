...
function BuildNavMesh()
{
    ...
    NavMesh.PushTriangle(0, 4, 9);
    NavMesh.PushTriangle(0, 9, 8);
    NavMesh.PushTriangle(9, 4, 10);
    NavMesh.PushTriangle(9, 10, 11);
    NavMesh.PushTriangle(9, 11, 12);
    NavMesh.PushTriangle(11, 10, 13);
    NavMesh.PushTriangle(11, 13, 14);
    NavMesh.PushTriangle(4, 5, 10);
}