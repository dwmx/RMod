//==============================================================================
//	R_RBotsDebug_CommandManager_BVH
//	Debug commands for NavMeshBVH
//==============================================================================
class R_RBotsDebug_CommandManager_BVH extends R_RBotsDebug_CommandManager;
...
function R_RBotsDebug_View_BVH GetDVBVH(R_RBotsDebug DebugMutator)
{
	...
	return R_RBotsDebug_View_BVH(DebugMutator.GetDebugView(Class'RBots.R_RBotsDebug_View_BVH'));
}
...
function HandleCommand_Show(R_RBotsDebug DebugMutator, PlayerPawn Sender)
{
	if(DebugMutator != None)
	{
		DebugMutator.EnableDebugView(Class'RBots.R_RBotsDebug_View_BVH');
	}
}
...
function HandleCommand_Hide(R_RBotsDebug DebugMutator, PlayerPawn Sender)
{
	if(DebugMutator != None)
	{
		DebugMutator.DisableDebugView(Class'RBots.R_RBotsDebug_View_BVH');
	}
}
...
function HandleCommand_Toggle(R_RBotsDebug DebugMutator, PlayerPawn Sender)
{
	if(DebugMutator != None)
	{
		DebugMutator.ToggleDebugView(Class'RBots.R_RBotsDebug_View_BVH');
	}
}